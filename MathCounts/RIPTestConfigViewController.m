...
- (void)viewDidLoad
{
    ...
    if ([sharedManager.operation isEqualToString:ADDITION]) {
        [self.backgroundLabel setBackgroundColor:[UIColor colorWithRed:0.7 green:0.1 blue:0.1 alpha:1.0]];
        [self.backgroundView setBackgroundColor:[UIColor colorWithRed:0.7 green:0.1 blue:0.1 alpha:1.0]];
    } else if ([sharedManager.operation isEqualToString:SUBTRACTION]) {
        [self.backgroundLabel setBackgroundColor:[UIColor colorWithRed:0.0 green:0.3 blue:0.7 alpha:1.0]];
        [self.backgroundView setBackgroundColor:[UIColor colorWithRed:0.0 green:0.3 blue:0.7 alpha:1.0]];
